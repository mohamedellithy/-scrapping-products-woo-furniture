...
class FilterFetchedProduct extends WooProductProperties{
    public const  prefix_url = "https://www.royalfurniture.ae/";
    ...
    public function set_product_categories(){
        if(self::$product["type_product"] != 'variate'):
            ...
            self::$product['categories'] = $this->crawler->filter('.woocommerce div.product .rey-breadcrumbs-item')->each(function (Crawler $node, $i){
                return $node->text();
            });
