...
class InsertParentProduct extends InsertFetchedProducts{
    ...
    public function inserted_or_updated_variate(){
        ...
        if(self::$fetched_product->product_variation == null){
            ...
            foreach(self::$fetched_product->product_variation as $product) {
                $variate = $product;

                $variate["type_product"]                = 'variate';
                ...
                $this->result['variate'][] = $variate_filtered; // $insert_new_item->result;
            }
        }
    }
