...
use App\FurnitureFetchApi\RoyalFurnitureApi\FilterFetchedProduct;
use App\FurnitureFetchApi\RoyalFurnitureApi\InsertParentProduct;
class FetchSingleProduct extends HandleFurnitureRequest {
    ...
    public function loop_fetch_products_rounds(){
        ...
        foreach($this->products as $product){
            ...
            $this->results[$product['title']['rendered']] = $insert_new_item; // $insert_new_item->result['variate'][1]->attributes;
            break;
        }
    }
