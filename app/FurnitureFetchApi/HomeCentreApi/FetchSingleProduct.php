...
use App\FurnitureFetchApi\HomeCentreApi\FilterFetchedProduct;
use App\FurnitureFetchApi\HomeCentreApi\InsertParentProduct;
    ...
    public function start_fetch_data(FetchProducts $products){
        ...
        if(method_exists($this,'loop_fetch_products_rounds')){
            ...
            for($round = 1; $round <= $paginate_count; $round++){
                ...
                // reset request body
                $body_json = '{"requests":[{"indexName":"prod_uae_homecentre_Product","params":"query=*&hitsPerPage=42&page='.$round.'&facets=*&facetFilters=%5B%22inStock%3A1%22%2C%22approvalStatus%3A1%22%2C%22allCategories%22%2C%22badge.title.en%3A-LASTCHANCE%22%5D&getRankingInfo=1&clickAnalytics=true&attributesToHighlight=null&analyticsTags=%5B%22furniture-bedroom%22%2C%22en%22%2C%22Desktop%22%5D&attributesToRetrieve=concept%2CmanufacturerName%2Curl%2C333WX493H%2C345WX345H%2C505WX316H%2C550WX550H%2C499WX739H%2Cbadge%2Cname%2Csummary%2CwasPrice%2Cprice%2CemployeePrice%2CshowMoreColor%2CproductType%2CchildDetail%2Csibiling%2CthumbnailImg%2CgallaryImages%2CisConceptDelivery%2CextProdType%2CreviewAvgRating%2CreferencesAvailable%2CitemType%2CbaseProductId&numericFilters=price%20%3E%201&query=*&maxValuesPerFacet=500&tagFilters=%5B%5B%22homecentre%22%5D%5D"}]}';
