...
class FilterFetchedProduct extends WooProductProperties{
    public const prefix_url = "https://www.wallsnation.com";
    ...
    public function set_product_thumbnail(){
        if(filter_var(self::$product['featured_image'],FILTER_VALIDATE_DOMAIN)):
        ...
        elseif(!filter_var(self::$product['featured_image'],FILTER_VALIDATE_DOMAIN)):
