...
use App\FurnitureFetchApi\WoodentWistApi\FilterFetchedProduct;
use App\FurnitureFetchApi\WoodentWistApi\InsertParentProduct;
class FetchSingleProduct extends HandleFurnitureRequest {
    ...
    public function loop_fetch_products_rounds(){
        ...
        foreach($this->products['slugs'] as $product){
            ...
            $this->endpoint = "https://www.woodentwist.com/collections/{$this->products['category']}/products/{$product}.js";
