...
{
    // protected fillable
    protected $fillable =['post_date','post_content','post_excerpt','post_title','post_status','post_name','post_type','post_date_gmt','post_modified_gmt'];
    /**
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope(new ProductVariationScope);
    }
    ...
    {
        return $this->belongsToMany(TermTaxonomy::class);
    }
    ...
    //     $this->attributes['post_date_gmt'] = date('Y-m-d H:i:s');
    // }
